        ...
        >
          <div>
            ...
            <mat-form-field appearance="outline" style="width: 100%">
              ...
              />
              <button
                (click)="toggleLastPasswordVisibility($event)"
                mat-icon-button
                matSuffix
              >
            ...
            <mat-form-field appearance="outline" style="width: 100%">
              ...
              <mat-error
                >new password required, and must be at least 6
    ...
    if (this.authForm.valid) {
      ...
      this.userService
        ...
        .catch(async (reason) => {
          ...
          this.updateUserProgress = false;
          this.snackBar.open(
            "Fails to change password, try again or contact support",
            "Ok",
            {
              duration: 3000
            }
