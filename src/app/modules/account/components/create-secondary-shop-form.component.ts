...
@Component({
  ...
  template: `
    <form
      *ngIf="createShopForm"
      ...
      (ngSubmit)="createShop()"
      class="create-shop-form-container"
    >
      <mat-form-field>
      ...
      <mat-form-field>
        ...
        <mat-select formControlName="category" class="" required="">
          <mat-option
            *ngFor="let category of profileState.categories | async"
      ...
      <mat-form-field>
        ...
        <mat-select formControlName="country" class="" required>
          <mat-option
            *ngFor="let country of profileState.countries | async"
  ...
  `,
  styleUrls: [
    "../styles/create-shop-dialog.style.scss",
...
export class CreateSecondaryShopComponent implements OnInit {
  ...
  async createShop(): Promise<void> {
    if (this.createShopForm.valid) {
      ...
      this.shopService
        .createShop(this.createShopForm.value)
