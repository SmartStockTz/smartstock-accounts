...
@Component({
  ...
  template: `
    ...
    <div class="line">
      ...
      <span class="line-space"></span>
      <span *ngIf="subs.subscription" class="paid-label">{{
        subs.reason
      }}</span>
      <span *ngIf="!subs.subscription" class="not-paid-label">{{
        subs.reason
      }}</span>
    </div>
    <div class="line">
    ...
    <div class="table-container">
      <table mat-table [dataSource]="costDataSource">
        <ng-container matColumnDef="cost">
          <th class="table-title" mat-header-cell *matHeaderCellDef>
            Cost ( TZS )
          </th>
    ...
    <div class="reference-container">
      <p class="reference-instruction-text">
        Ukimaliza weka kumbukumbu namba apo chini. Kisha bofya thibitisha
        malipo.
      </p>
      <div class="reference-input-container">
        <input
          placeholder="Kumbumbuku namba"
      ...
      <button
        ...
        [disabled]="confirmOnProgress"
        mat-button
        class="reference-confirm-button"
      >
        <span *ngIf="!confirmOnProgress" class="reference-confirm-text"
          >Thibitisha malipo.</span
        >
        <span *ngIf="confirmOnProgress" class="reference-confirm-text"
          >Subiri...</span
        >
